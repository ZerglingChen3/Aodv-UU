...
$n(13) set Y_ 900
$n(13) set Z_ 0
$ns_ initial_node_pos $n(13) 25
$n(13) random-motion 0

set udp0 [new Agent/UDP]
$ns_ attach-agent $n(11) $udp0
set sink0 [new Agent/Null]
$ns_ attach-agent $n(6) $sink0
$ns_ connect $udp0 $sink0
set cbr0 [new Application/Traffic/CBR]
$cbr0 attach-agent $udp0
$cbr0 set packetSize_ $pktsize
$cbr0 set interval_ $pktrate
$ns_ at 10.000000 "$cbr0 start"
$ns_ at 30.000000 "$cbr0 stop"

#set udp1 [new Agent/UDP]
#$ns_ attach-agent $n(0) $udp1
#set sink1 [new Agent/Null]
#$ns_ attach-agent $n(8) $sink1
#$ns_ connect $udp1 $sink1
#set cbr1 [new Application/Traffic/CBR]
#$cbr1 attach-agent $udp1
#$cbr1 set packetSize_ $pktsize
#$cbr1 set interval_ $pktrate
#$ns_ at 50.000000 "$cbr1 start"
#$ns_ at 59.000000 "$cbr1 stop"

#$ns_ at 10.000000 "$n(12) setdest 10 900 1000"
$ns_ at 50.000000 "$n(3) setdest 250 800 1000"
$ns_ at 50.000000 "$n(6) setdest 250 900 1000"
